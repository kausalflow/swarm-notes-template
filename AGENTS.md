# Swarm Notes Template Agent Guidelines

This file provides system instructions for AI coding assistants (Gemini, Claude, Copilot, Antigravity, etc.) interacting with this workspace.
